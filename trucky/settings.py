...
# SECRET_KEY = 'django-insecure-x%7u1#m0odbcmukvfg3urb^9ae7-vmkvj4-*%h%i+(p&#=*2fp'
...
ASGI_APPLICATION = "trucky.asgi.application"
...
print("Loaded MAP_API_KEY =", os.getenv("MAP_API_KEY"))
